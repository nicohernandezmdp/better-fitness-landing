...
export default function SocialProofSection() {
  const [googleData, setGoogleData] = useState({ rating: 4.8, totalReviews: 113 });
  ...
  const stats = [
    {
      ...
      icon: <GoogleIcon />,
      stars: googleData.rating,
    },
    {
      value: googleData.totalReviews,
      decimals: 0,
      prefix: "+",
      suffix: "",
      label: "reseñas de nuestros clientes",
      sublabel: "",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
          {stats.map((s, i) => (
            ...
            >
              ...
              {s.sublabel && <p className="text-zinc-400 text-sm">{s.sublabel}</p>}
            </motion.div>
          ))}
        </div>
